 ...
 */
package br.com.surittec.surispring.data.criteria;
...
public class JPQL {
	...
	/**
	 * Retorna uma lista de entidades que atendem aos critérios da busca. Já faz o <code>cast</code> para a classe <code>resultType</code> passada.
	 * 
	 * @param resultType
	 * @return
	 */
	...
	/**
	 * Retorna uma única entidade que atenda aos critérios da busca. Já faz o <code>cast</code> para a classe <code>resultType</code> passada.
	 * 
	 * @param resultType
	 * @return
	 */
	...
	/**
	 * Retorna uma única entidade que atenda aos critérios da busca. Trata o caso de não haver resultado, retornando <code>null</code>. Já faz o
	...
	/**
	 * Retorna uma única entidade que atenda aos critérios da busca. Trata o caso de não haver resultado, retornando <code>null</code>.
	 * 
	 * @return
	 */
